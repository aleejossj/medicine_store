...
<title>Aramax 5/50 | Medicine Store</title>

</head>
<body>
		<main>
			<div class="img">
			<img src="img/6.jpg" witdh="250px" height="250px">
			</div>
		<div class="producto">
			<h1>Aramax 5/50</h1><br>
			<div class="presentacion">
			<h3>Descripcion</h3><br>
		    </div>
			<div class="texto">
				<p>Es un medicamento que asocia las propiedades vasodilatadoras periféricas de los calcio-antagonistas, Amlodipino, con el control de la angiotensina II mediada por los ARA II selectivos. </p>
			</div>
				<div class="conteiner">
					<div class="contador">
