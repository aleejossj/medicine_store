...
<title>Prueba de embarazo clearblue | Medicine Store</title>

</head>
<body>
		<main>
			<div class="img">
			<img src="img/8.jpg" witdh="250px" height="250px">
			</div>
		<div class="producto">
			<h1>Prueba de embarazo clearblue</h1><br>
			<div class="presentacion">
			<h3>Descripcion</h3><br>
		    </div>
			<div class="texto">
				<p>La Prueba de Embarazo Clearblue® Detección Rápida ha sido diseñada para ofrecerle la experiencia de la prueba de embarazo más fácil, con la precisión que espera de Clearblue®, y un resultado de “Embarazada” tan rápido como en 1 minuto. </p>
			</div>
				<div class="conteiner">
					<div class="contador">
