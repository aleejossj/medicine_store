...
<title>Seda Dental Oral B Satin Tape | Medicine Store</title>

</head>
<body>
		<main>
			<div class="img">
			<img src="img/14.jpg" witdh="250px" height="250px">
			</div>
		<div class="producto">
			<h1>Seda Dental Oral B Satin Tape Caja Con 25 Metros</h1><br>
			<div class="presentacion">
			<h3>Descripcion</h3><br>
		    </div>
			<div class="texto">
				<p>En adición a su textura satinada para envolverse confortablemente alrededor de los dedos, Oral-B Satin Tape tiene forma de cinta para ayudar a limpiar espacios más anchos entre los dientes. </p>
			</div>
				<div class="conteiner">
					<div class="contador">
