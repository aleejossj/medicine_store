...
<title>Crema Dental Colgate Luminous White | Medicine Store</title>

</head>
<body>
		<main>
			<div class="img">
			<img src="img/13.jpg" witdh="250px" height="250px">
			</div>
		<div class="producto">
			<h1>Crema Dental Colgate Luminous White Brilliant Caja Con Tubo Con 125 mL</h1><br>
			<div class="presentacion">
			<h3>Descripcion</h3><br>
		    </div>
			<div class="texto">
				<p>Crema Dental Luminous White tiene para ti y sorprende a todos con una dentadura impecable. Sus microcristales aceleradores de blanqueamiento contienen ingredientes similares a los usados por los dentistas, asegurando resultados espectaculares. </p>
			</div>
				<div class="conteiner">
					<div class="contador">
